...
/*   Updated: 2017/02/20 17:13:09 by tferrari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_moin_on(char **str, t_print ptf, uint64_t nb, int i)
{
	if (i == 1)
		*str = ft_strcat(*str, "0");
	if (ptf.accuracy > 0)
		*str = ft_strnccat(*str, '0', ptf.accuracy - ft_intlen_llo(nb));
	*str = (ptf.c == 'X') ?  ft_strcat(*str, ft_itoa_llo(nb)) :
	ft_strcat(*str, ft_itoa_llo(nb));
	if (ptf.accuracy == 0)
		*str = ft_strnccat(*str, ' ', ptf.zero - ft_intlen_llo(nb) - i);
	else
...
static void	ft_moin_off(char **str, t_print ptf, uint64_t nb, int i)
{
	...
	if (ptf.accuracy == 0 && i == 1 && nb != 0)
		*str = ft_strcat(*str, "0");
	if (nb != 0)
		*str = ft_strcat(*str, ft_itoa_llo(nb));
